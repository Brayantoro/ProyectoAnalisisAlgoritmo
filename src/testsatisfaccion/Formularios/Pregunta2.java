                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addComponent(btnBorrar, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 165, Short.MAX_VALUE)
...
private void runGame() {
    ...
    private void btnContinuarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnContinuarActionPerformed
        ...
        if (caminorecorrido == mejorCamino && pruebaCorrecta) {
            infoPrueba.setResultadoPrueba2(3);
        } else if (pruebaCorrecta && caminorecorrido != mejorCamino) {
            infoPrueba.setResultadoPrueba2(2);
        } else {
            infoPrueba.setResultadoPrueba2(1);
        }

        infoPrueba.setPrueba2Solucionada(pruebaCorrecta);

        Pregunta3 pregunta3 = new Pregunta3();
        pregunta3.infoPrueba = infoPrueba;
